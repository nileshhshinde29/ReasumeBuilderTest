...
function Add() {
  ...
  const submitFunction = () => {
    const localData = JSON.parse(localStorage.getItem("allData"))
      ...
      : [];
const ind = JSON.parse(localStorage.getItem("index"));
    //   const newData = [...localData, obj];
       const newData = localData.map((item, i)=>i==i? obj: item);
    // console.log(newData);
  ...
  useEffect(() => {
    ...
    const old = data.filter((itm, index) => index == ind);
    setObj(old[0]);
  }, []);
                ...
                <div class="mb-3">
                  <div class="form-check form-check-inline">
                    <input
                      ...
                      class="form-check-input"
                      type="checkbox"
                      checked={obj.skills.includes("Angular") ? true : false}
                      name="skill"
                      value="Angular"
                    />
                  ...
                  <div class="form-check form-check-inline">
                    <input
                      checked={obj.skills.includes("React") ? true : false}
                      onChange={(e) => handleSkills(e.target.value)}
                      class="form-check-input"
                      type="checkbox"
                      name="skill"
                  ...
                  <div class="form-check form-check-inline">
                    <input
                      checked={obj.skills.includes("Node.js") ? true : false}
                      onChange={(e) => handleSkills(e.target.value)}
                      class="form-check-input"
                      type="checkbox"
                      name="skill"
                  ...
                  <div class="form-check form-check-inline">
                    <input
                      checked={obj.skills.includes("Javascript") ? true : false}
                      onChange={(e) => handleSkills(e.target.value)}
                      class="form-check-input"
                      type="checkbox"
                      name="skill"
                  ...
                  <div class="form-check form-check-inline">
                    <input
                      checked={obj.skills.includes("fulter") ? true : false}
                      onChange={(e) => handleSkills(e.target.value)}
                      class="form-check-input"
                      type="checkbox"
                      name="skill"
                  ...
                  <div class="form-check form-check-inline">
                    <input
                      checked={obj.skills.includes("java") ? true : false}
                      onChange={(e) => handleSkills(e.target.value)}
                      class="form-check-input"
                      type="checkbox"
                      name="skill"
                      ...
                      <div class="card-body">
                        ...
                        <div class="row g-3">
                          <div class="col-6">
                            ...
                            <input
                              value={obj.experience[i].company}
                              type="text"
                              class="form-control"
                              onChange={(e) =>
                                setObj({
                                  ...obj,
                                  experience: obj.experience.map(
                                    (items, index) =>
                                      i == index
                          ...
                          <div class="col-6">
                            ...
                            <input
                              value={obj.experience[i].duration}
                              type="number"
                              class="form-control"
                              onChange={(e) =>
                                setObj({
                          ...
                          <div class="col-12">
                            ...
                            <textarea
                              value={obj.experience[i].responsibility}
                              onChange={(e) =>
                                setObj({
                                  ...obj,
                                  experience: obj.experience.map(
